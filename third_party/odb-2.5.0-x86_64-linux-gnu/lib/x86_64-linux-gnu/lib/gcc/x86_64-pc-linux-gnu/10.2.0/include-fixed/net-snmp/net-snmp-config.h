...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=/usr' '--build=x86_64-pc-linux-gnu' '--host=x86_64-pc-linux-gnu' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--datadir=/usr/share' '--sysconfdir=/etc' '--localstatedir=/var/lib' '--docdir=/usr/share/doc/net-snmp-5.9-r2' '--htmldir=/usr/share/doc/net-snmp-5.9-r2/html' '--with-sysroot=/' '--libdir=/usr/lib64' '--disable-internal-md5' '--enable-ipv6' '--disable-mfd-rewrites' '--disable-embedded-perl' '--disable-ucd-snmp-compatibility' '--with-bzip2' '--without-elf' '--without-kmem-usage' '--without-mysql' '--without-nl' '--without-pcap' '--without-pci' '--without-perl-modules' '--without-python-modules' '--without-rpm' '--with-openssl' '--with-libwrap' '--with-zlib' '--disable-static' '--enable-shared' '--with-default-snmp-version=3' '--with-install-prefix=/var/tmp/portage/net-analyzer/net-snmp-5.9-r2/image' '--with-ldflags=-Wl,-Bsymbolic-functions' '--with-logfile=/var/log/net-snmpd.log' '--with-mib-modules=host ucd-snmp/dlmod ucd-snmp/diskio ucd-snmp/extensible mibII/mta_sendmail etherlike-mib/dot3StatsTable' '--with-persistent-directory=/var/lib/net-snmp' '--with-sys-contact=root@Unknown' '--with-sys-location=Unknown' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=x86_64-pc-linux-gnu' 'CFLAGS=-O3 -march=native -pipe' 'LDFLAGS=-Wl,-Bsymbolic-functions'"
...
#define PACKAGE_STRING "Net-SNMP 5.9"
#endif
